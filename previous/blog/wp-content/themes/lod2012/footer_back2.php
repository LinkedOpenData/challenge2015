		...
		<div id="footer">
			<!-- 
                        <font size="2">LODチャレンジJapan2014 スポンサー、パートナー、サポータのご協力宜しくお願いします！！</font><font size="2"><br>各募集要項は本ページのスポンサー欄<br>
<a href="http://lod.sfc.keio.ac.jp/challenge2014/sponsorrecruit.html">「スポンサー募集ページ」</a><br>
<a href="http://lod.sfc.keio.ac.jp/challenge2014/partner_platform_data.html">「データ提供パートナー／基盤提供パートナー募集」</a><br>
<a href="http://lod.sfc.keio.ac.jp/challenge2014/partner_media.html">「メディアパートナー募集」</a><br>
<a href="http://lod.sfc.keio.ac.jp/challenge2014/supporter.html">「サポーター募集」</a>をご覧下さい</font>
                        -->
			...
			<div id="btmSponsorBK">
					...
					<!--  
						//<ul class="gold">
						//<li><a href="http://www.city.osaka.lg.jp/toshikeikaku/page/0000246527.html" target="_blank"><img src="common/img/sponsores/oosaka_city.png" alt="大阪市"></a></li>
						//</ul>
					-->
				...
				<div id="footerMenu">
					...
					<p id="facebook"><a href="http://www.facebook.com/LOD.challenge.Japan#" title="LOD Challenge 2012 facebookページ"><img src="common/img/facebook.png" alt="Facebook" width="32" height="32" /></a></p>
                               ...
                               -->
				<div id="credit">
					<p>Copyright&copy;2014 Linked Open Data Challenge Japan 2014.</p>
				</div><!--// credit //-->
